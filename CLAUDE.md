...
| :--- | :--- | :--- | :--- | :--- | :--- |
| T5 | «revisió **parcial** acabada» | `b81e3fa` (2026-07-13) | Cap resum de resolució global. **Els 29 ítems (1.1–4.12) comprovats un per un al corpus el 2026-09-23: 28 aplicats, 1 obert.** Els dos d'execució que restaven (4.8 i 4.12) es van executar el mateix dia; queda només la **decisió 3.8**, entrada viva del `TODO.md §T5` | cap | **pendent** |
