...
::: {#lst-multiplicacio-secuencial}
```{.defrault filename="Pseudocodi"}
// Inicialització
...
Multiplicació seqüencial d'enters de 32 bits amb algorisme de restauració, on $x$ dividend, $y$ divisor, $z$ el quocient i $w$ el residu.
:::
