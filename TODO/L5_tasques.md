...
`TODO/TODO.md` actualitzat en conseqüència: L5 ja no consta com a pendent en aquest punt. **Tancat** (auditoria, sessió 2, 2026-09-21): L3 va quedar complint amb `6ee1a8a` (2026-09-21); `b6c8124` (2026-09-20) n'havia resolt el primer dels dos blocs. La regla ja és consolidada a `13_contrib.qmd §Convencions globals del laboratori`, verificada sobre els 25 blocs de `.text` amb `_start` de L1–L6.
