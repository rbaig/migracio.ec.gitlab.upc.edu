Nom d'aquest xat: `EC A5-E5-S5 Revisió interna`
...
2. Llegeix els fitxers principals a revisar: `A5.qmd`, `E5.qmd` i `S5.qmd`.
...
7. Genera la llista completa d'accions a realitzar; guarda-la al fitxer `T5_P_tasques.md` i ofereix-me-la per descarregar.
