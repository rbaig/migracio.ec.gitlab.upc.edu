...
## A. Solucions noves a `S2.qmd`

1. **`sol-p3-memoria-endianness`** (secció «Operands en memòria», entre `lw-sw` i `lb-lh`, mirall de l'ordre de `E2.qmd`):
