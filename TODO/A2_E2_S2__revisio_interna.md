Nom d'aquest xat: `EC A2-E2-S2 Revisió interna`
...
2. Llegeix els fitxers principals a revisar: `A2.qmd`, `E2.qmd` i `S2.qmd`.
...
7. Genera la llista completa d'accions a realitzar; guarda-la al fitxer `T2_P_tasques.md` i ofereix-me-la per descarregar.
