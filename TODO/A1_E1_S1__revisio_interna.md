Nom d'aquest xat: `EC A1-E1-S1 Revisió interna`
...
2. Llegeix els fitxers principals a revisar: `A1.qmd`, `E1.qmd` i `S1.qmd`.
...
7. Genera la llista completa d'accions a realitzar; guarda-la al fitxer `T1_P_tasques.md` i ofereix-me-la per descarregar.
