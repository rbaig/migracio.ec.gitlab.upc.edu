Nom d'aquest xat: `EC L4 Revisió interna`
...
2. Llegeix el fitxer principal a revisar (`L4.qmd`) i els fitxers dels apunts les seves referències creuades (`Ax.qmd`, amb x ∈ [1, 9]).
...
7. Genera la llista completa d'accions a realitzar; guarda-la al fitxer `L4_tasques.md` i ofereix-me-la per descarregar.
