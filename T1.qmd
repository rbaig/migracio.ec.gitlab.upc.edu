...
* La llargada d'un `int` (16, 32 o 64 bits) no la estableix el llenguatge, sinó l'ABI del sistema on s'executarà el programa.
...
nombres en **coma flotant** ([Tema 5](#sec-tema-coma-flotant)).
:::
