...
1. **Gestió de memòria:** Mitjançant els punters, el programador decideix exactament on resideixen les dades. Això és vital en sistemes **bare-metal** per accedir a registres de control del maquinari que estan "mapajats" en memòria (*Memory-Mapped I/O*).
...
<!-- TODO estandarditzar mermaid quan bug `height=480` solucionat -->
...
<!-- TODO reescriure per evitar bullet list amb un sol bullet -->
