...
3. **Normalitzar** el resultat (desplaçar la mantissa fins que la part entera sigui 1, ajustant l'exponent en conseqüència). Cal comprovar sobreeiximent/*underflow*.
...
4. **Normalitzar** el resultat. cal comprovar sobreeiximent/*underflow*.
