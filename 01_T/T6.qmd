...
Es pot reduir el temps d'execució reduint el retard $CPI_{i}$ de cada tipus d'instrucció, però això requereix millorar el disseny de la microarquitectura. També es pot reduir el nombre d'instruccions $n_{i}$ d'aquells tipus d'instruccions més lentes (amb major $CPI_{i}$) encara que sigui a costa d'augmentar el nombre de les més ràpides, si la suma és inferior, millorant l'habilitat del compilador.
...
**Solució 1**: Càlcul el núm d'instruccions i cicles totals de cada programa:
...
::: {.light-content}
![](/figs_auto/T6_tc_tc_prima__original_light.svg){width="40%"}
:::
::: {.dark-content}
![](/figs_auto/T6_tc_tc_prima__original_dark.svg){width="40%"}
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T6_tc_tc_prima__original_light.svg){width="50%"}
:::
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T6_amdahl__original_light.svg){width="40%"}
:::
::: {.dark-content}
![](/figs_auto/T6_amdahl__original_dark.svg){width="40%"}
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T6_amdahl__original_light.svg){width="50%"}
:::
...
On $C_{i}$ és la capacitat equivalent en farads del circuit connectat a la sortida de la porta. $C_{i}$ depèn del nombre (**fan-out**), material i grandària dels transistors i connectors connectats a la sortida de la porta. $V_{CC}$ és la tensió d'alimentació en volts. El corrent elèctric generat en tot el circuit durant un cicle de rellotge és igual a la càrrega i descàrrega agregada de totes les portes que commutin dividida pel temps de cicle de rellotge $t_{clock}$:
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T6_not_cmos__original_light.svg){width="50%"}
:::
::: {.dark-content}
![](/figs_auto/T6_not_cmos__original_dark.svg){width="50%"}
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T6_not_cmos__original_light.svg)
:::
