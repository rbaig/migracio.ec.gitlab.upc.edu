...
## Pseudoinstrucció — `neg` (canvi de signe) {#sec-pseudoinstruccio-neg-canvi-de-signe}
...
Gràcies a l'equivalència entre la resta la resta i la suma amb el negatiu del subtrahend, el maquinari necessita **un sol circuit** per a la suma i la resta (@sec-suma-resta-i-canvi-de-signe).
...
## Demostració de les condicions de sobreeiximent en Ca2 {#sec-demostracio-de-les-condicions-de-sobreeiximent-en-ca2}
...
En un sumador amb propagació de **sobreeiximent** (*carry*) de $n$ bits, es produeix sobreeiximent quan el sobreeiximent d'entrada al bit de més pes difereix del sobreeiximent de sortida:
...
## Detecció de sobreeiximent per maquinari: el sumador amb propagació de l'arrossegament {#sec-deteccio-de-sobreeiximent-per-maquinari-el-sumador-amb-propagacio-de-larrossegament}
...
## Càlcul de la condició de sobreeiximent per programari {#sec-calcul-de-la-condicio-de-sobreeiximent-per-programari}
...
## Algorisme de multiplicació de naturals en base 2 {#sec-algorisme-de-multiplicacio-de-naturals-en-base-2}
...
::: {.light-content}
![](/figs_auto/T4_multiplicador_sequencial__original_light.svg)
:::
::: {.dark-content}
![](/figs_auto/T4_multiplicador_sequencial__original_dark.svg)
:::
:::
...
## Seguiment del circuit multiplicador (4 bits) {#sec-seguiment-del-circuit-multiplicador-4-bits}
...
## Circuit combinacional de multiplicació {#sec-circuit-combinacional-de-multiplicacio}
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T4_multiplicador_arbre__original_light.svg)
:::
::: {.dark-content}
![](/figs_auto/T4_multiplicador_arbre__original_dark.svg)
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T4_multiplicador_arbre__original_light.svg)
...
## RV32IM ISA — Instruccions de multiplicació entera {#sec-rv32im-isa-instruccions-de-multiplicacio-entera}
...
## Detecció de sobreeiximent en la multiplicació entera {#sec-deteccio-de-sobreeiximent-en-la-multiplicacio-entera}
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T4_matriu_emmagatzematge__original_light.svg)
:::
::: {.dark-content}
![](/figs_auto/T4_matriu_emmagatzematge__original_dark.svg)
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T4_matriu_emmagatzematge__original_light.svg)
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T4_matriu_offset_ij__original_light.svg)
:::
::: {.dark-content}
![](/figs_auto/T4_matriu_offset_ij__original_dark.svg)
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T4_matriu_offset_ij__original_light.svg)
...
## Accés a `mat[i][j]` — índexs variables {#sec-acces-a-mat-i-j-indexs-variables}
...
## Accés a `mat[i][j]` — columna constant {#sec-acces-a-mat-i-j-columna-constant}
...
## Accés a `mat[i][j]` — fila constant {#sec-acces-a-mat-i-j-fila-constant}
...
## Accés a `mat[i][j]` — fila i columna constants {#sec-acces-a-mat-i-j-fila-i-columna-constants}
...
## Optimització #1 — Accés seqüencial aplicat a una fila de matriu {#sec-optimitzacio-1-acces-sequencial-aplicat-a-una-fila-de-matriu}
...
## Optimització #2 — Avaluació de la condició al final {#sec-optimitzacio-2-avaluacio-de-la-condicio-al-final}
...
## Optimització #3 — Eliminació de la variable d'inducció {#sec-optimitzacio-3-eliminacio-de-la-variable-dinduccio}
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T4_matriu_recorreguts_strides__original_light.svg)
:::
::: {.dark-content}
![](/figs_auto/T4_matriu_recorreguts_strides__original_dark.svg)
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T4_matriu_recorreguts_strides__original_light.svg)
...
## `sumacolumna` — accés aleatori {#sec-sumacolumna-acces-aleatori}
...
## `sumacolumna` — accés seqüencial (optimitzacions #1, #2 i #3) {#sec-sumacolumna-acces-sequencial-optimitzacions-1-2-i-3}

L'stride per recórrer una columna és $\texttt{NC} \cdot T = \texttt{NC} \cdot 2$.

Com que `NC` no és potència de 2, l'stride `NC*2` tampoc ho és: el desplaçament fins a la sentinella (`nfiles·NC*2`) s'ha de calcular amb `mul`, ja que no es pot obtenir amb `slli`.
...
## Algorisme de divisió de naturals en base 2 {#sec-algorisme-de-divisio-de-naturals-en-base-2}
...
::: {.content-visible when-format="html"}
::: {.light-content}
![](/figs_auto/T4_divisor_sequencial__original_light.svg)
:::
::: {.dark-content}
![](/figs_auto/T4_divisor_sequencial__original_dark.svg)
:::
:::
::: {.content-visible when-format="pdf"}
![](/figs_auto/T4_divisor_sequencial__original_light.svg)
...
## Seguiment del circuit divisor (4 bits) {#sec-seguiment-del-circuit-divisor-4-bits}
...
## RV32IM ISA — Instruccions de divisió entera {#sec-rv32im-isa-instruccions-de-divisio-entera}
...
## Traducció de divisió i mòdul enters {#sec-traduccio-de-divisio-i-modul-enters}
