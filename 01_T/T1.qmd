...
La resta s'implementa com una suma amb el **negatiu del subtrahend**. Per negar un nombre en Ca2 s'aplica la **regla del canvi de signe**: complementar tots els bits i sumar 1.
