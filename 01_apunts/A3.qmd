...
El mecanisme descrit en aquesta secció és el d'un **sistema real amb SO**. A **EC** no hi ha ni SO ni carregador (@imp-directe-sobre-processador): els programes no reben `argc` ni `argv` i no tornen enlloc en acabar. El punt d'entrada és `_start` i la sortida es fa amb `li a7, 93` + `ecall` (@nte-programa-esquelet).
