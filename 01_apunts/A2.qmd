...
<!-- TODO(startup.s) Reactivar si es manté l'esquelet específic d'EC amb startup.s. Si es manté, corregir abans: _start (no __start), li a7, 93 (no a7, 10). -->
<!--
::: {#nte-programa-esquelet .callout-note}
## Esquelet mínim d'un programa genèric
```{.s filename="esquelet.s"}
...
: {tbl-colwidths="[14,14,23,49]" style="width: 95%; margin: auto;"}
