...
Els blocs d'aquest tema usen aquestes constants dins d'expressions aritmètiques (`NF*NC*4`, `NC*4`, `mat + 3*NC*4`) per fer visible l'estructura del càlcul d'adreces: vegeu @imp-ec-operands-expressions per a què se n'admet a la teoria i què cal escriure al laboratori.
:::
